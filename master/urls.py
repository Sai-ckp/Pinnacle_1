...
urlpatterns = [
    ...
    path('student/<int:pk>/', views.master_student_view, name='master_student_view'),
    ...
    path('main/', views.blank_view, name='blank_view'),
     ...
     path('communication-dashboard/', views.communication_dashboard, name='communication_dashboard'),
    ...
    path('course-types/add/', views.course_type_create, name='course_type_create'),
        path('course-types/<int:pk>/edit/', views.course_type_edit, name='course_type_edit'),
